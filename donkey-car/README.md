...
OpenMV Cam Donkey Mount<br />![OpenMV Cam Donkey Mount](images/parts/camera-mount.jpg "OpenMV Cam Donkey Mount") | https://www.shapeways.com/product/G7YQBUMRC/openmv-cam-donkey-mount<br /><br />You can download the STL file for this part [here](download/OpenMV_Donkey_Mount.stl).<br /><br />*OpenMV Cam Donkey Mount by Chris Anderson*. | 1 | $21.18
